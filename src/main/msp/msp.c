...
case MSP_NAME:
    ...
    case MSP_RC_DEADBAND:
        ...
        sbufWriteU16(dst, 0); // flight3DConfig()->deadband3d_throttle
        break;
    ...
    case MSP_FILTER_CONFIG :
        ...
        sbufWriteU8(dst, 0); // was currentPidProfile->dterm_lpf2_type
        sbufWriteU16(dst, 0);
        sbufWriteU16(dst, 0);
        sbufWriteU16(dst, 0);
        sbufWriteU16(dst, 0);
    ...
    case MSP_PID_ADVANCED:
        ...
        sbufWriteU8(dst, 0); // was feedforward_transition
...
static mspResult_e mspProcessInCommand(mspDescriptor_t srcDesc, int16_t cmdMSP, sbuf_t *src)
{
    ...
    case MSP_SET_RC_DEADBAND:
        ...
        sbufReadU16(src); // flight3DConfigMutable()->deadband3d_throttle
        break;
    ...
    case MSP_SET_ADVANCED_CONFIG:
        ...
        if (sbufBytesRemaining(src) >= 2) {
            sbufReadU16(src);  // motorConfigMutable()->digitalIdleOffsetValue
        }
        if (sbufBytesRemaining(src)) {
    ...
    case MSP_SET_PID_ADVANCED:
        ...
        sbufReadU8(src); // was feedforward_transition
